...
namespace LeaveManagement_API.Endpoint
{
    public static class LeaveBalanceEndpoint
    {
        ...
        public static void ConfigureLeaveBalanceEndPoints(this WebApplication app)
        {
            ...
            app.MapPost("/api/LeaveBalance", CreateLeaveBalance).WithName("CreateLeaveBalance").Accepts<LeaveBalanceDTO>("application/json").Produces<APIResponse>(201).Produces(400);
            app.MapPut("/api/LeaveBalance/{id:int}", UpdateLeaveBalance).WithName("UpdateELeaveBalance").Accepts<LeaveBalanceDTO>("application/json").Produces<APIResponse>(200).Produces(400);
